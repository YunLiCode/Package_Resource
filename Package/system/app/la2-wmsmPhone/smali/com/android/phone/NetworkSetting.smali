...
.method static synthetic access$200(Lcom/android/phone/NetworkSetting;)V
    ...
    .prologue
    .line 54
    invoke-direct {p0}, Lcom/android/phone/NetworkSetting;->displayNetworList()V
...
.method private displayNetworList()V
    .locals 5
...
.method private static getRadioTechDes(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method private networksListLoaded(Ljava/util/List;I)V
    ...
    .line 423
    const-string v4, "networksListLoaded hideProgressPanel"
    ...
    const-string v4, "Fail to dismiss network load list dialog"
    ...
    invoke-direct {v0, p0, v4}, Landroid/preference/Preference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/phone/NetworkSetting;->getNetworkTitle(Lcom/android/internal/telephony/OperatorInfo;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v5, v6, v7}, Lcom/android/phone/NetworkSetting;->getLocalString(Ljava/lang/String;II)Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/OperatorInfo;->getRadioTech()Ljava/lang/String;

    move-result-object v5

    invoke-static {v5}, Lcom/android/phone/NetworkSetting;->getRadioTechDes(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 465
    iget-object v4, p0, Lcom/android/phone/NetworkSetting;->mNetworkList:Landroid/preference/PreferenceGroup;
