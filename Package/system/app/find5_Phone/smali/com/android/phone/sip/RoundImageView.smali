.class public Lcom/android/phone/sip/RoundImageView;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 26
    iput v1, p0, Lcom/android/phone/sip/RoundImageView;->mBorderThickness:I

    .line 28
    const/4 v0, -0x1

    iput v0, p0, Lcom/android/phone/sip/RoundImageView;->defaultColor:I

    .line 30
    iput v1, p0, Lcom/android/phone/sip/RoundImageView;->mBorderOutsideColor:I

    .line 31
    iput v1, p0, Lcom/android/phone/sip/RoundImageView;->mBorderInsideColor:I

    .line 33
    iput v1, p0, Lcom/android/phone/sip/RoundImageView;->defaultWidth:I

    .line 34
    iput v1, p0, Lcom/android/phone/sip/RoundImageView;->defaultHeight:I

    .line 38
    iput-object p1, p0, Lcom/android/phone/sip/RoundImageView;->mContext:Landroid/content/Context;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 44
    invoke-direct {p0, p2}, Lcom/android/phone/sip/RoundImageView;->setCustomAttributes(Landroid/util/AttributeSet;)V
...
.method private drawCircleBorder(Landroid/graphics/Canvas;II)V
    ...
    .line 206
    iget v1, p0, Lcom/android/phone/sip/RoundImageView;->mBorderThickness:I
    ...
    .line 207
    iget v1, p0, Lcom/android/phone/sip/RoundImageView;->defaultWidth:I

    div-int/lit8 v1, v1, 0x2

    int-to-float v1, v1

    iget v2, p0, Lcom/android/phone/sip/RoundImageView;->defaultHeight:I
...
.method private setCustomAttributes(Landroid/util/AttributeSet;)V
    ...
    .line 54
    iget-object v1, p0, Lcom/android/phone/sip/RoundImageView;->mContext:Landroid/content/Context;

    sget-object v2, Lcom/android/phone/R$styleable;->roundImageView:[I
    ...
    iget v2, p0, Lcom/android/phone/sip/RoundImageView;->defaultColor:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 67
    invoke-virtual {p0}, Lcom/android/phone/sip/RoundImageView;->getDrawable()Landroid/graphics/drawable/Drawable;
    ...
    .line 72
    :cond_1
    invoke-virtual {p0}, Lcom/android/phone/sip/RoundImageView;->getWidth()I

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {p0}, Lcom/android/phone/sip/RoundImageView;->getHeight()I
    ...
    .line 75
    invoke-virtual {p0, v2, v2}, Lcom/android/phone/sip/RoundImageView;->measure(II)V
    ...
    .line 80
    iget v0, p0, Lcom/android/phone/sip/RoundImageView;->defaultWidth:I
    ...
    iput v0, p0, Lcom/android/phone/sip/RoundImageView;->defaultWidth:I

    .line 84
    :cond_2
    iget v0, p0, Lcom/android/phone/sip/RoundImageView;->defaultHeight:I
    ...
    iput v0, p0, Lcom/android/phone/sip/RoundImageView;->defaultHeight:I

    .line 94
    :cond_3
    iget v0, p0, Lcom/android/phone/sip/RoundImageView;->mBorderInsideColor:I

    iget v2, p0, Lcom/android/phone/sip/RoundImageView;->defaultColor:I

    if-eq v0, v2, :cond_5

    iget v0, p0, Lcom/android/phone/sip/RoundImageView;->mBorderOutsideColor:I
    ...
    iget v2, p0, Lcom/android/phone/sip/RoundImageView;->mBorderThickness:I
    ...
    iget v3, p0, Lcom/android/phone/sip/RoundImageView;->mBorderInsideColor:I

    invoke-direct {p0, p1, v2, v3}, Lcom/android/phone/sip/RoundImageView;->drawCircleBorder(Landroid/graphics/Canvas;II)V
    ...
    iget v3, p0, Lcom/android/phone/sip/RoundImageView;->mBorderThickness:I

    div-int/lit8 v3, v3, 0x2

    add-int/2addr v2, v3

    iget v3, p0, Lcom/android/phone/sip/RoundImageView;->mBorderOutsideColor:I

    invoke-direct {p0, p1, v2, v3}, Lcom/android/phone/sip/RoundImageView;->drawCircleBorder(Landroid/graphics/Canvas;II)V

    .line 120
    :goto_2
    invoke-virtual {p0, v1, v0}, Lcom/android/phone/sip/RoundImageView;->getCroppedRoundBitmap(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;

    move-result-object v1

    .line 121
    iget v2, p0, Lcom/android/phone/sip/RoundImageView;->defaultWidth:I
    ...
    iget v3, p0, Lcom/android/phone/sip/RoundImageView;->defaultHeight:I
